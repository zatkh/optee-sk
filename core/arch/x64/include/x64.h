...
static inline void sleep_test_r9(uint64_t in_val)
{
...
static inline void set_in_r10(uint64_t in_val)
{
	__asm__ __volatile__ (
		"movq %0, %%r10"
		:
...
static inline void set_in_r11(uint64_t in_val)
{
	__asm__ __volatile__ (
		"movq %0, %%r11"
		:
...
static inline void set_in_r12(uint64_t in_val)
{
	__asm__ __volatile__ (
		"movq %0, %%r12"
		:
...
static inline void set_in_r13(uint64_t in_val)
{
	__asm__ __volatile__ (
		"movq %0, %%r13"
		:
